...
//       const daily = forecastData.forecast.filter(item => item.dt_txt.includes('12:00:00'));
//       setForecast(daily);
//       setError('');
//     } catch (err) {
...
//       // Forecast (note the /forecast path)
...
//         const daily = forecastData.forecast.filter(item =>
//           item.date.includes('12:00:00')
//         );
//         setForecast(daily);
//       } else {
//         setForecast([]);
